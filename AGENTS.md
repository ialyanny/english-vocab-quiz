...
- 高中開學考四科**教材版本**（出題內容需以此為準）：
  ...
  - 地理、化學、生物、公民與社會：南一版
  - 物理：泰宇版
  - ※ `subjects.js` 已依南科實中 114 學年度高二開學考範圍表對齊：
    - 國文：龍騰版第一～二冊
    - 數學：龍騰版第一、二冊（數A：數與式/指數/對數/多項式/直線與圓/數列/數據分析/排列組合/機率/三角比）
    - 自然：物理(泰宇力學一全冊)、化學(南一物質與能量全冊)、生物(南一細胞與遺傳全冊)、地科(南一全冊)
    - 社會：歷史(龍騰一二冊)、地理(南一一二冊)、公民(南一)
