...
// ===== 單字資料：依回分組（藍色字體 + 7月空英）=====
// 已完成（05:32字/32句 06:46字/46句 07:64字/48句 08:45字/45句 09:46字/46句 10:45字/45句 11:46字/46句 JUL:103字/103句）
const WORDS_BY_UNIT = {
  "05": [
    ["occupy", "擁有（某職務）；占據；使忙碌"],
    ["occupation", "職業；占領"],
    ["explanation", "解釋，說明"],
    ["initial", "初期的；（姓名的）第一個字母；在……上簽署姓名的首字母"],
    ["initially", "開始時，最初"],
    ["estimate", "估計"],
    ["expand", "（使）（尺寸或數量）擴大，增加"],
    ["expansion", "擴大"],
    ["consequence", "結果；重要性"],
    ["consequent", "由……的原因而發生的；必然的"],
    ["consequently", "因此，所以"],
    ["convince", "使確信；說服"],
    ["convinced", "確信的"],
    ["illustrate", "為……畫插圖；說明"],
    ...
    ["eliminate", "殲滅；剔除，淘汰"],
    ["formula", "配方；公式"],
    ["instruct", "教授，指導；指示，告知"],
    ["instructor", "指導者，教練"],
    ["eventual", "終究的，最後的"],
    ["eventually", "終究，到頭來"],
    ["demonstrate", "示範；示威"],
    ["demonstration", "示範；示威活動"],
    ["leisurely", "休閒的；從容不迫地"],
    ["adequate", "充分的，適當的"],
    ["inadequate", "不適當的"],
    ["slight", "輕微的；輕視；冷落"],
    ["candidate", "候選人"],
    ["bond", "關係；債券；（使）黏合；建立關係"],
    ["appropriate", "適當的，合適的；撥（款）"],
    ["relevant", "有關的"]
  ],
  "05-ext": [
    ["occupied", "忙碌的"],
  ...
  "06": [
    ...
    ["approval", "贊成，同意"],
    ["appoint", "選定；指定；指派"],
    ["appointment", "約定，（公務上的）約會；職位，職務；任命"],
    ["panel", "嵌版；儀表板；專題討論小組"],
    ["expose", "暴露；接觸"],
    ["exposure", "暴露，曝晒；接觸"],
    ["possess", "擁有，持有；（鬼魂）附身於"],
    ["possession", "擁有；財產"],
    ["intellectual", "智力的；知識分子"],
    ["intelligence", "聰明才智；情報"],
    ["copper", "紅銅；紅銅色的"],
    ["shift", "轉移，改變；輪班"],
    ["resolve", "解決；下決心；決心"],
    ["resolution", "志願，期望；決心"],
    ["determination", "決心"],
    ["orchestra", "管弦樂團"],
    ["compose", "組成，構成；譜（曲）；寫（詩、信等）"],
    ["composer", "作曲家"],
    ["composition", "成分；（樂曲、畫、詩等）作品；作文"],
    ["colleague", "同事"],
    ["proposal", "提議，建議；求婚"],
    ["liar", "說謊者"]
  ],
  "06-ext": [
    ...
    ["uncommitted", "未承諾的"],
    ["character", "個性；人物"],
    ["characterize", "使具有……的特徵"],
    ["furniture", "傢俱"],
    ["furnishings", "傢俱、窗簾等裝飾物件"],
    ["furnished", "含有傢俱的"],
    ["provide", "提供"],
    ["approve", "批准，核可；贊同"],
    ["agreement", "同意"],
  ...
  "11": [
    ...
    ["rhythm", "節奏"],
    ["rhyme", "押韻"],
    ["volunteer", "自願者，義工；自告奮勇"],
    ["voluntary", "自願的，自動的"],
    ["prompt", "促使；立刻的；（演員）提詞"],
    ["fiction", "（虛構）小說類"],
    ["forbid", "禁止"],
    ["entertain", "娛樂"],
    ["entertainment", "娛樂，樂趣；娛樂節目"],
    ["restore", "復原"],
    ["delicate", "脆弱的；精緻的"],
    ["delicacy", "美食；細緻；慎重"],
    ["fragile", "脆弱的"],
  ...
  "11-ext": [
    ...
    ["strength", "力量"],
    ["weaken", "減弱，削弱"],
    ["enthusiastic", "熱心的，熱誠的"],
    ["enthusiastically", "熱衷地"],
    ["fire", "發射"],
    ["casualty", "死傷人員"],
    ["inspiring", "激勵人心的"],
    ["inspired", "受到啟發的；卓越的"],
...
const SENTENCES_BY_UNIT = {
  "05": [
    { s: "She decided to {blank} the position of CEO after a long career in finance.", blank: "occupy", base: "occupy", zh: "她在金融業工作多年後，決定出任執行長一職。" },
    { s: "Teaching is a noble {blank} that requires patience and dedication.", blank: "occupation", base: "occupation", zh: "教育是一項需要耐心與奉獻的高尚職業。" },
    { s: "He gave a clear {blank} for why the project was delayed.", blank: "explanation", base: "explanation", zh: "他對專案延誤的原因做了解釋。" },
    { s: "Please sign your {blank} in the top right corner of the form.", blank: "initial", base: "initial", zh: "請在表格右上角簽署您的姓名首字母。" },
    { s: "We {blank} thought the plan was risky, but it turned out to be successful.", blank: "initially", base: "initially", zh: "我們最初認為這個計畫風險很高，但結果證明它是成功的。" },
    { s: "Experts {blank} that the economy will recover by next year.", blank: "estimate", base: "estimate", zh: "專家估計經濟將在明年復甦。" },
    { s: "The company plans to {blank} its operations into the Asian market.", blank: "expand", base: "expand", zh: "公司計畫將業務擴展到亞洲市場。" },
    { s: "The {blank} of the highway reduced traffic congestion in the city.", blank: "expansion", base: "expansion", zh: "高速公路的擴建減少了城內的交通擁堵。" },
    { s: "Every action has a {blank}, so think before you act.", blank: "consequence", base: "consequence", zh: "每個行動都有後果，所以行動前要深思熟慮。" },
    { s: "The {blank} effect of the policy was a rise in unemployment.", blank: "consequent", base: "consequent", zh: "該政策帶來的必然結果是失業率上升。" },
    { s: "It rained heavily; {blank}, the outdoor event was canceled.", blank: "consequently", base: "consequently", zh: "雨下得很大，因此戶外活動被取消了。" },
    { s: "The evidence was strong enough to {blank} the jury of his guilt.", blank: "convince", base: "convince", zh: "證據充分到足以讓陪審團確信他有罪。" },
    { s: "I am {blank} that we will win the game if we keep playing hard.", blank: "convinced", base: "convinced", zh: "我確信只要我們繼續努力比賽，我們就會贏。" },
    { s: "The teacher used a diagram to {blank} the water cycle.", blank: "illustrate", base: "illustrate", zh: "老師用圖表來說明水循環。" },
    { s: "The book is full of colorful {blank}s that help children learn.", blank: "illustration", base: "illustration", zh: "這本書充滿了幫助兒童學習的彩色插圖。" },
    { s: "The {blank} of the house are quiet and peaceful.", blank: "surroundings", base: "surroundings", zh: "這所房子的周圍環境安靜而祥和。" },
    { s: "The new rules aim to {blank} all forms of discrimination.", blank: "eliminate", base: "eliminate", zh: "新規則旨在消除所有形式的歧視。" },
    { s: "Scientists are trying to find a {blank} for clean energy.", blank: "formula", base: "formula", zh: "科學家們正在尋找清潔能源的配方。" },
    { s: "The manual will {blank} you on how to operate the machine safely.", blank: "instruct", base: "instruct", zh: "手冊將指導你如何安全地操作機器。" },
    { s: "She hired a personal {blank} to help her improve her swimming technique.", blank: "instructor", base: "instructor", zh: "她請了一位私人教練來幫助她改進游泳技巧。" },
    { s: "The {blank} outcome of the negotiations was a mutual agreement.", blank: "eventual", base: "eventual", zh: "談判的最終結果是達成了一項共同協議。" },
    { s: "He {blank} got the job he had been applying for.", blank: "eventually", base: "eventually", zh: "他終於得到了他一直在申請的那份工作。" },
    { s: "The scientist will {blank} the experiment to the class.", blank: "demonstrate", base: "demonstrate", zh: "科學家將向全班示範這個實驗。" },
    { s: "There was a large {blank} in the square to protest the new law.", blank: "demonstration", base: "demonstration", zh: "廣場上有一場大型示威活動以抗議新法律。" },
    { s: "They took a {blank} walk through the park to relax.", blank: "leisurely", base: "leisurely", zh: "他們在公園裡從容不迫地散步以放鬆心情。" },
    { s: "Make sure you have {blank} time to finish the report.", blank: "adequate", base: "adequate", zh: "確保你有足夠的時間完成報告。" },
    { s: "The funding was {blank} for the scale of the project.", blank: "inadequate", base: "inadequate", zh: "資金對於該項目的規模來說是不夠的。" },
    { s: "There was a {blank} error in the calculation that led to the mistake.", blank: "slight", base: "slight", zh: "計算中有一個輕微的錯誤導致了這個失誤。" },
    { s: "He is the leading {blank} for the mayor election this year.", blank: "candidate", base: "candidate", zh: "他是今年市長選舉的主要候選人。" },
    { s: "They shared a strong {blank} formed during their years of friendship.", blank: "bond", base: "bond", zh: "他們在多年的友誼中建立了深厚的關係。" },
    { s: "It is {blank} to wear a helmet when riding a motorcycle.", blank: "appropriate", base: "appropriate", zh: "騎摩托車時戴頭盔是適當的。" },
    { s: "Please provide only {blank} information for this application.", blank: "relevant", base: "relevant", zh: "請為這份申請只提供相關資訊。" }
  ],
  "06": [
    { s: "The local government provided financial {blank} to the small businesses affected by the flood.", blank: "assistance", base: "assistance", zh: "當地政府為受洪水影響的小企業提供了財務援助。" },
    { s: "There is a wide {blank} between the opinions of the two political parties on this issue.", blank: "gulf", base: "gulf", zh: "在這項議題上，兩黨之間存在著巨大的意見分歧。" },
    { s: "The athlete felt an {blank} desire to win the championship after years of hard training.", blank: "intense", base: "intense", zh: "經過多年的刻苦訓練，這位運動員強烈渴望贏得冠軍。" },
    { s: "The {blank} of the earthquake was measured at 7.0 on the Richter scale.", blank: "intensity", base: "intensity", zh: "地震的強度在裡氏規模上測得為7.0級。" },
    { s: "The company conducted an {blank} investigation into the cause of the product failure.", blank: "intensive", base: "intensive", zh: "該公司對產品失敗的原因進行了徹底的調查。" },
    { s: "The {blank} for the scholarship is extremely fierce this year.", blank: "competition", base: "competition", zh: "今年的獎學金競爭異常激烈。" },
    { s: "We need to develop a {blank} strategy to stay ahead in the market.", blank: "competitive", base: "competitive", zh: "我們需要制定一個競爭性策略，以在市場中保持領先。" },
    { s: "Our main {blank} in the tech industry is a large multinational corporation.", blank: "competitor", base: "competitor", zh: "我們在科技行業的主要競爭對手是一家大型跨國公司。" },
    { s: "You may need to {blank} your sleep schedule before the long trip.", blank: "adjust", base: "adjust", zh: "在長途旅行前，你可能需要調整你的睡眠時間。" },
    { s: "It took him a while to make the necessary {blank} to his new job responsibilities.", blank: "adjustment", base: "adjustment", zh: "他花了一段時間來適應新工作的責任。" },
    { s: "The charity will {blank} the donated clothes to families in need.", blank: "distribute", base: "distribute", zh: "該慈善機構將把捐贈的衣物分發給有需要的家庭。" },
    { s: "The {blank} of wealth in this region is quite uneven.", blank: "distribution", base: "distribution", zh: "該地區的財富分配相當不均。" },
    { s: "The teacher did not {blank} the student's effort, but rather praised his improvement.", blank: "criticize", base: "criticize", zh: "老師沒有批評學生的努力，而是讚揚了他的進步。" },
    { s: "The movie received mixed {blank} from the audience, with some loving it and others disliking it.", blank: "criticism", base: "criticism", zh: "這部電影獲得了觀眾褒貶不一的評價，有人喜歡，有人不喜歡。" },
    { s: "The patient's condition is {blank}, and doctors are monitoring him closely.", blank: "critical", base: "critical", zh: "病人的情況危急，醫生正在密切監測他。" },
    { s: "The art {blank} wrote a detailed review of the new exhibition in the newspaper.", blank: "critic", base: "critic", zh: "這位藝術評論家在報紙上對新展覽撰寫了一篇詳細的評論。" },
    { s: "The success of the project was {blank} due to the team's hard work and dedication.", blank: "largely", base: "largely", zh: "項目的成功主要歸功於團隊的辛勤工作和奉獻。" },
    { s: "He {blank} a serious error in judgment that cost the company millions of dollars.", blank: "commit", base: "commit", zh: "他犯了一個嚴重的判斷錯誤，使公司損失了數百萬元。" },
    { s: "She is a {blank} employee who always goes above and beyond her duties.", blank: "committed", base: "committed", zh: "她是一名盡職盡責的員工，總是超越職責範圍努力工作。" },
    { s: "A key {blank} of the species is its ability to change color.", blank: "characteristic", base: "characteristic", zh: "該物種的一個關鍵特徵是其變色的能力。" },
    { s: "After working for thirty years, he decided to {blank} and travel the world.", blank: "retire", base: "retire", zh: "工作了三十年後，他決定退休並環遊世界。" },
    { s: "The {blank} professor shared his wisdom with the younger generation of scientists.", blank: "retired", base: "retired", zh: "這位退休教授與年輕一代科學家分享了他的智慧。" },
    { s: "He is looking forward to his {blank} and plans to spend more time with his family.", blank: "retirement", base: "retirement", zh: "他期待著退休，並計劃花更多時間陪伴家人。" },
    { s: "The hotel will {blank} the rooms with modern furniture before the guests arrive.", blank: "furnish", base: "furnish", zh: "在客人抵達之前，酒店將為房間配備現代傢俱。" },
    { s: "The board gave its final {blank} to the new marketing strategy.", blank: "approval", base: "approval", zh: "董事會對新的行銷策略給予了最終的贊成。" },
    { s: "The CEO decided to {blank} a new manager to oversee the project.", blank: "appoint", base: "appoint", zh: "執行長決定指派一位新經理來監督該專案。" },
    { s: "He has a busy {blank} at the office tomorrow morning.", blank: "appointment", base: "appointment", zh: "他明早在公司有一個繁忙的公務約會。" },
    { s: "The car's {blank} displays important information like speed and fuel level.", blank: "panel", base: "panel", zh: "汽車的儀表板顯示速度和油量等重要資訊。" },
    { s: "The documentary aims to {blank} the public to the harsh realities of climate change.", blank: "expose", base: "expose", zh: "這部紀錄片旨在讓公眾接觸到氣候變遷的嚴酷現實。" },
    { s: "Prolonged {blank} to sunlight can cause skin damage.", blank: "exposure", base: "exposure", zh: "長時間曝曬在陽光下可能會造成皮膚損傷。" },
    { s: "Only a few wealthy individuals {blank} such rare and valuable artifacts.", blank: "possess", base: "possess", zh: "只有少數富裕人士擁有如此罕見且珍貴的文物。" },
    { s: "The police are trying to trace the {blank} of the stolen painting.", blank: "possession", base: "possession", zh: "警方正在試圖追查那幅被盜畫作的下落。" },
    { s: "Solving this problem requires a high level of {blank} ability.", blank: "intellectual", base: "intellectual", zh: "解決這個問題需要高度的智力能力。" },
    { s: "Her quick {blank} allowed her to adapt to the new environment rapidly.", blank: "intelligence", base: "intelligence", zh: "她敏捷的聰明才智使她能迅速適應新環境。" },
    { s: "The statue was made of solid {blank} and had a shiny red surface.", blank: "copper", base: "copper", zh: "這座雕像由純紅銅製成，表面閃著紅色的光澤。" },
    { s: "The nurse's {blank} ends at midnight, and then the night team takes over.", blank: "shift", base: "shift", zh: "護士的輪班在午夜結束，然後夜班團隊接手。" },
    { s: "We need to {blank} this conflict between the two departments immediately.", blank: "resolve", base: "resolve", zh: "我們需要立即解決這兩個部門之間的衝突。" },
    { s: "His main {blank} for the New Year was to learn a new language.", blank: "resolution", base: "resolution", zh: "他新年最大的決心是學習一門新語言。" },
    { s: "Her {blank} to succeed despite the odds was inspiring to everyone.", blank: "determination", base: "determination", zh: "她Despite困難仍要成功的決心啟發了每個人。" },
    { s: "The {blank} played a beautiful symphony that moved the audience to tears.", blank: "orchestra", base: "orchestra", zh: "管弦樂團演奏了一首動人的交響曲，令觀眾淚流滿面。" },
    { s: "The committee is {blank} the majority of the city's population.", blank: "compose", base: "compose", zh: "委員會構成了該市人口的大部分。（註：此處用法較少見，通常用comprises，但compose可表組成）" },
    { s: "Beethoven was one of the greatest {blank} in history.", blank: "composer", base: "composer", zh: "貝多芬是歷史上最偉大的作曲家之一。" },
    { s: "The {blank} of the air in this area is heavily polluted.", blank: "composition", base: "composition", zh: "該地區空氣的成分嚴重受污染。" },
    { s: "I discussed the project details with my {blank} during the lunch break.", blank: "colleague", base: "colleague", zh: "我在午餐休息時與我的同事討論了專案細節。" },
    { s: "He made a formal {blank} to buy the company from its current owners.", blank: "proposal", base: "proposal", zh: "他正式提議從現有的所有者手中購買該公司。" },
    { s: "It is dangerous to trust a known {blank} with important secrets.", blank: "liar", base: "liar", zh: "信任一個已知的說謊者來保守重要秘密是危險的。" }
  ],
  "07": [
  ...
  "11": [
    { s: "The weather conditions are {blank} for the outdoor concert.", blank: "favorable", base: "favorable", zh: "戶外音樂會的天氣狀況是有利的。" },
    { s: "She has {blank} hobbies, including painting and hiking.", blank: "multiple", base: "multiple", zh: "她有多重興趣，包括繪畫和遠足。" },
    { s: "He is studying {blank} at university to understand human behavior.", blank: "psychology", base: "psychology", zh: "他正在大學研究心理學以了解人類行為。" },
    { s: "The {blank} impact of the news on the team was significant.", blank: "psychological", base: "psychological", zh: "這則新聞對團隊的心理影響是顯著的。" },
    { s: "We consulted a {blank} to help us manage our stress levels.", blank: "psychologist", base: "psychologist", zh: "我們諮詢了一位心理學家來幫助我們管理壓力水平。" },
    { s: "She wore a silver {blank} with a delicate design.", blank: "bracelet", base: "bracelet", zh: "她戴著一條設計精緻的銀手鐲。" },
    { s: "Regular exercise can {blank} your immune system.", blank: "strengthen", base: "strengthen", zh: "定期運動可以鞏固你的免疫系統。" },
    { s: "The {blank} was held in a quiet church.", blank: "funeral", base: "funeral", zh: "葬禮是在一座安靜的教堂舉行的。" },
    { s: "His {blank} for learning new languages is inspiring.", blank: "enthusiasm", base: "enthusiasm", zh: "他對學習新語言的熱愛是鼓舞人心的。" },
    { s: "The company plans to {blank} a new smartphone next month.", blank: "launch", base: "launch", zh: "該公司計劃下個月發表一款新智慧型手機。" },
    { s: "Her speech {blank} the students to work harder.", blank: "inspire", base: "inspire", zh: "她的演說鼓舞學生更努力學習。" },
    { s: "The artist found {blank} in the beauty of nature.", blank: "inspiration", base: "inspiration", zh: "藝術家從自然之美中找到了靈感。" },
    { s: "My parents give me a weekly {blank} for snacks and books.", blank: "allowance", base: "allowance", zh: "我父母每週給我零用錢買零食和書。" },
    { s: "The music created a sense of {blank} in the room.", blank: "harmony", base: "harmony", zh: "音樂在房間裡創造了一種和諧感。" },
    { s: "They live in a {blank} relationship with their neighbors.", blank: "harmonious", base: "harmonious", zh: "他們與鄰居維持著和諧的關係。" },
    { s: "It was {blank} that we found the lost keys.", blank: "fortunate", base: "fortunate", zh: "我們找到丟失的鑰匙真是太幸運了。" },
    { s: "{blank}, the rain stopped just before we left.", blank: "fortunately", base: "fortunately", zh: "幸運地是，雨在我們離開前就停了。" },
    { s: "It is {blank} that the project failed due to a mistake.", blank: "unfortunate", base: "unfortunate", zh: "由於一個錯誤導致專案失敗，這是不幸的。" },
    { s: "He suffered a great {blank} when his car was stolen.", blank: "misfortune", base: "misfortune", zh: "當他的車被偷時，他遭受了巨大的不幸。" },
    { s: "It is difficult to {blank} with such a heavy workload.", blank: "cope", base: "cope", zh: "要應付如此繁重的工作量是很困難的。" },
    { s: "We need a {blank} plan to solve this problem.", blank: "realistic", base: "realistic", zh: "我們需要一個實際的計畫來解決這個問題。" },
    { s: "The teacher gave a {blank} explanation of the complex topic.", blank: "thorough", base: "thorough", zh: "老師對這個複雜的主題給出了徹底的解釋。" },
    { s: "You should buy {blank} to protect your new car.", blank: "insurance", base: "insurance", zh: "你應該購買保險來保護你的新車。" },
    { s: "You should {blank} your car before the long road trip.", blank: "insure", base: "insure", zh: "在長途旅行前，你應該為你的汽車投保。" },
    { s: "She is an {blank} student who always gets high grades.", blank: "outstanding", base: "outstanding", zh: "她是一名傑出的學生，總是取得高分。" },
    { s: "The train will {blank} from the station at 9 AM.", blank: "depart", base: "depart", zh: "火車將於上午9點從車站出發。" },
    { s: "Please check the {blank} board for any flight changes.", blank: "departure", base: "departure", zh: "請查看出發看板以確認航班是否有變動。" },
    { s: "The movie has impressive {blank} effects.", blank: "visual", base: "visual", zh: "這部電影有令人印象深刻的視覺效果。" },
    { s: "The {blank} quality of the recording is very clear.", blank: "audio", base: "audio", zh: "錄音的音質非常清晰。" },
    { s: "We used {blank} aids to teach the history lesson.", blank: "audio-visual", base: "audio-visual", zh: "我們使用視聽輔助工具來教授歷史課。" },
    { s: "The song has a fast {blank} that makes you want to dance.", blank: "rhythm", base: "rhythm", zh: "這首歌有快速的節奏，讓你想要跳舞。" },
    { s: "The poet used {blank} to make the poem more memorable.", blank: "rhyme", base: "rhyme", zh: "詩人使用押韻讓詩歌更令人難忘。" },
    { s: "Many {blank}s helped clean up the beach last weekend.", blank: "volunteer", base: "volunteer", zh: "上週末許多志工幫助清理了海灘。" },
    { s: "Donation to the charity is entirely {blank}.", blank: "voluntary", base: "voluntary", zh: "對慈善機構的捐款完全是自願的。" },
    { s: "The teacher {blank}ed the students to raise their hands.", blank: "prompt", base: "prompt", zh: "老師促使學生舉手。" },
    { s: "He enjoys reading {blank} novels in his free time.", blank: "fiction", base: "fiction", zh: "他喜歡在空閒時間閱讀虛構小說。" },
    { s: "The school {blank}s students from using mobile phones in class.", blank: "forbid", base: "forbid", zh: "學校禁止學生在課堂上使用手機。" },
    { s: "The magician will {blank} the audience with his tricks.", blank: "entertain", base: "entertain", zh: "魔術師將以他的把戲娛樂觀眾。" },
    { s: "Watching movies is a popular form of {blank}.", blank: "entertainment", base: "entertainment", zh: "看電影是一種流行的娛樂方式。" },
    { s: "It took weeks to {blank} the old painting to its original state.", blank: "restore", base: "restore", zh: "花了幾週時間將那幅舊畫復原到原狀。" },
    { s: "Handle the {blank} vase with extreme care.", blank: "delicate", base: "delicate", zh: "請極其小心地處理這個精緻的花瓶。" },
    { s: "The chef is known for his {blank} in cooking.", blank: "delicacy", base: "delicacy", zh: "這位廚師以烹飪的細緻著稱。" },
    { s: "Glass is {blank} and breaks easily.", blank: "fragile", base: "fragile", zh: "玻璃很脆弱，容易破碎。" },
    { s: "Safety should be our top {blank} when driving.", blank: "priority", base: "priority", zh: "駕駛時，安全應該是我們的首要考慮事項。" },
    { s: "He received wide {blank} for his contribution to science.", blank: "recognition", base: "recognition", zh: "他因對科學的貢獻而獲得廣泛認可。" },
    { s: "I ordered a plate of {blank} with meat sauce.", blank: "pasta", base: "pasta", zh: "我點了一盤肉醬義大利麵。" }
  ],
  "JUL": [
